from app.application.review.dto import ApproveDeliveryCommand, ReviewDeliveryResult
...
class ApproveDeliveryUseCase(UseCase[ApproveDeliveryCommand, ReviewDeliveryResult]):
    def __init__(
        self,
