...
export const config = {
  matcher: '/((?!api|_next/static|_next/image|favicon.ico|robots.txt|sitemap.xml|.*\\.(?:png|jpg|jpeg|gif|svg|ico|webp|txt|xml|css|js|map|woff|woff2|ttf|eot|json|webmanifest)$).*)',
};
