...
class Role(Entity):
    ...
    # rule: is_system marks a seed-owned catalog row -> protects the Role entity itself from
    # rename/delete (no such use case exists). It must NOT gate UserRole/RolePermission link
    # operations (AssignRole/RemoveRole/GrantPermission/RevokePermission) — see AUTHORIZATION.md
...
class SystemRoleImmutableError(BusinessRuleViolationError): ...   # reserved for catalog-entity
                                                                 # (rename/delete) guards only —
                                                                 # never for UserRole/RolePermission links
class LastAdminRoleRemovalError(InvalidStateTransitionError): ... # -> 409; last active admin assignment
...
class IFreelancerProfileRepository(ABC):
    ...
    def list_by_approval_status(self, status: FreelancerApprovalStatus, limit: int | None = None, offset: int | None = None) -> list[FreelancerProfile]: ...
    def count_by_approval_status(self, status: FreelancerApprovalStatus) -> int: ...
...
class IFreelancerLevelHistoryRepository(ABC):
    ...
    def list_by_profile(self, profile_id: EntityId, limit: int | None = None, offset: int | None = None) -> list[FreelancerLevelHistory]: ...
    def count_by_profile(self, profile_id: EntityId) -> int: ...

class IResumeRepository(ABC):
    def add(self, resume: Resume) -> None: ...
    def get_by_id(self, resume_id: EntityId) -> Resume: ...
    def update(self, resume: Resume) -> None: ...
    def delete(self, resume_id: EntityId) -> None: ...
    def list_by_profile(self, profile_id: EntityId, limit: int | None = None, offset: int | None = None) -> list[Resume]: ...
    def count_by_profile(self, profile_id: EntityId) -> int: ...
    def get_current(self, profile_id: EntityId) -> Resume | None: ...
    def get_by_file_asset_id(self, file_asset_id: EntityId) -> Resume | None: ...

class IPortfolioItemRepository(ABC):
    def add(self, item: PortfolioItem) -> None: ...
    def get_by_id(self, item_id: EntityId) -> PortfolioItem: ...
    def list_by_profile(self, profile_id: EntityId, limit: int | None = None, offset: int | None = None) -> list[PortfolioItem]: ...
    def count_by_profile(self, profile_id: EntityId) -> int: ...
...
class ICategoryRepository(ABC):
    ...
    def list_active(self, limit: int | None = None, offset: int | None = None) -> list[Category]: ...
...
class IProjectRepository(ABC):
    ...
    def list_by_customer(self, customer_user_id: EntityId, status: ProjectStatus | None = None, limit: int | None = None, offset: int | None = None) -> list[Project]: ...
    def list_available_for_freelancer(self, level_id: EntityId, limit: int | None = None, offset: int | None = None) -> list[Project]: ...
    def list_by_supervisor(self, supervisor_user_id: EntityId, limit: int | None = None, offset: int | None = None) -> list[Project]: ...
    def list_by_category(self, category_id: EntityId, limit: int | None = None, offset: int | None = None) -> list[Project]: ...
    def count_by_customer(self, customer_user_id: EntityId, status: ProjectStatus | None = None) -> int: ...
    def count_available_for_freelancer(self, level_id: EntityId) -> int: ...
    def count_by_supervisor(self, supervisor_user_id: EntityId) -> int: ...
    def count_open_by_category(self, category_id: EntityId) -> int: ...
...
class IProjectApplicationRepository(ABC):
    ...
    def list_by_project(self, project_id: EntityId, limit: int | None = None, offset: int | None = None) -> list[ProjectApplication]: ...
...
class IProjectDeliveryRepository(ABC):
    ...
    def list_by_project(self, project_id: EntityId, limit: int | None = None, offset: int | None = None) -> list[ProjectDelivery]: ...
    def count_by_project(self, project_id: EntityId) -> int: ...
...
class IProjectRevisionRequestRepository(ABC):
    ...
    def list_by_project(self, project_id: EntityId, limit: int | None = None, offset: int | None = None) -> list[ProjectRevisionRequest]: ...
    def count_by_project(self, project_id: EntityId) -> int: ...
...
class IProjectStatusHistoryRepository(ABC):
    ...
    def list_by_project(self, project_id: EntityId, limit: int | None = None, offset: int | None = None) -> list[ProjectStatusHistory]: ...
    def count_by_project(self, project_id: EntityId) -> int: ...
```
...
class ISupervisorReviewRepository(ABC):
    ...
    def list_pending_for_supervisor(self, supervisor_user_id: EntityId, limit: int | None = None, offset: int | None = None) -> list[SupervisorReview]: ...
    def count_pending_for_supervisor(self, supervisor_user_id: EntityId) -> int: ...
...
class ITicketRepository(ABC):
    ...
    def list_for_user(self, user_id: EntityId, limit: int | None = None, offset: int | None = None) -> list[Ticket]: ...
    def count_for_user(self, user_id: EntityId) -> int: ...
    def update(self, ticket: Ticket) -> None: ...

class ITicketMessageRepository(ABC):
    def add(self, message: TicketMessage) -> None: ...
    def list_by_ticket(self, ticket_id: EntityId, limit: int | None = None, offset: int | None = None) -> list[TicketMessage]: ...
    def count_by_ticket(self, ticket_id: EntityId) -> int: ...
```
